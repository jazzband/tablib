...
Tablib is an :ref:`MIT Licensed <mit>` format-agnostic tabular dataset library, 
written in Python.
...
::
   ...
   [{"Last Name": "Reitz", "First Name": "Kenneth", "Age": 22},
    {"Last Name": "Monke", "First Name": "Bessie", "Age": 21}]
...
**Dave Coutts**
   ...
   You really hit a sweat spot for managing tabular data with a minimal amount of code and effort.
...
The User's Guide, which is mostly prose,
begins with some background information about Tablib,
then focuses on step-by-step instructions for getting the most out of your datasets.
